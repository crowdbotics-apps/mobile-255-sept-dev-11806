...
export default function apiReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case types.API_V1_HGGFKHJFKHG_LIST:
    case types.API_V1_HGGFKHJFKHG_LIST_SUCCEEDED:
    case types.API_V1_HGGFKHJFKHG_LIST_FAILED:
    case types.API_V1_HGGFKHJFKHG_CREATE:
    case types.API_V1_HGGFKHJFKHG_CREATE_SUCCEEDED:
    case types.API_V1_HGGFKHJFKHG_CREATE_FAILED:
    case types.API_V1_HGGFKHJFKHG_READ:
    case types.API_V1_HGGFKHJFKHG_READ_SUCCEEDED:
    case types.API_V1_HGGFKHJFKHG_READ_FAILED:
    case types.API_V1_HGGFKHJFKHG_UPDATE:
    case types.API_V1_HGGFKHJFKHG_UPDATE_SUCCEEDED:
    case types.API_V1_HGGFKHJFKHG_UPDATE_FAILED:
    case types.API_V1_HGGFKHJFKHG_PARTIAL_UPDATE:
    case types.API_V1_HGGFKHJFKHG_PARTIAL_UPDATE_SUCCEEDED:
    case types.API_V1_HGGFKHJFKHG_PARTIAL_UPDATE_FAILED:
    case types.API_V1_HGGFKHJFKHG_DELETE:
    case types.API_V1_HGGFKHJFKHG_DELETE_SUCCEEDED:
    case types.API_V1_HGGFKHJFKHG_DELETE_FAILED:
